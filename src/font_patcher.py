...
PATCH_SET = [
    {'name': "Seti-UI + Custom",
     ...
     'sym_start': 0xE4FA, 'sym_end': 0xE52E, 'src_start': 0xE5FA},
    {'name': "Devicons",
     'filename': "devicons.ttf",
     'sym_start': 0xE600, 'sym_end': 0xE6C5, 'src_start': 0xE700},
    {'name': "Powerline Symbols",
     'filename': "PowerlineSymbols.otf",
     'sym_start': 0xE0A0, 'sym_end': 0xE0A2, 'src_start': None},
    {'name': "Powerline Symbols",
     'filename': "PowerlineSymbols.otf",
     'sym_start': 0xE0B0, 'sym_end': 0xE0B3, 'src_start': None},
    {'name': "Powerline Extra Symbols",
     'filename': "PowerlineExtraSymbols.otf",
     'sym_start': 0xE0A3, 'sym_end': 0xE0A3, 'src_start': None},
    {'name': "Powerline Extra Symbols",
     'filename': "PowerlineExtraSymbols.otf",
     'sym_start': 0xE0B4, 'sym_end': 0xE0C8, 'src_start': None},
    {'name': "Powerline Extra Symobls",
     'filename': "PowerlineExtraSymbols.otf",
     'sym_start': 0xE0CA, 'sym_end': 0xE0CA, 'src_start': None},
    {'name': "Powerline Extra Symobls",
     'filename': "PowerlineExtraSymbols.otf",
     'sym_start': 0xE0CC, 'sym_end': 0xE0D4, 'src_start': None},
    {'name': "Pomicons",
     'filename': "Pomicons.otf",
     'sym_start': 0xE000, 'sym_end': 0xE00A, 'src_start': None},
    {'name': "Font Awesome",
     'filename': "FontAwesome.otf",
     'sym_start': 0xF000, 'sym_end': 0xF2E0, 'src_start': None},  # Maximize
    {'name': "Font Awesome Extension",
     'filename': "font-awesome-extension.ttf",
     'sym_start': 0xE000, 'sym_end': 0xE0A9, 'src_start': 0xE200},
    {'name': "Font Linux",
     'filename': "font-logos.ttf",
     # Power, Power On/Off, Power On, Sleep
     'sym_start': 0xF100, 'sym_end': 0xF11C, 'src_start': 0xF300},
    {'name': "Power Symbols",
     'filename': "Unicode_IEC_symbol_font.otf",
     # Heavy Circle (aka Power Off)
     'sym_start': 0x23FB, 'sym_end': 0x23FE, 'src_start': None},
    {'name': "Power Symbols",
     'filename': "Unicode_IEC_symbol_font.otf",
    ...
    {'name': "Octicons",
     'filename': "octicons.ttf",
     'sym_start': 0X26A1, 'sym_end': 0X26A1, 'src_start': None},  # Zap
    {'name': "Octicons",
     'filename': "octicons.ttf",
