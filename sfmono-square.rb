...
class SfmonoSquare < Formula
  ...
  url "https://github.com/delphinus/homebrew-sfmono-square/archive/v3.0.4-pre-14.tar.gz"
  sha256 "f09c460821fb2f6e614c06648364f5621681fbd988c3363b58d2fc15ccacea19"
  version "3.0.4-pre-14"
